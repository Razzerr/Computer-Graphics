...
var createTexture2D= function(gl, type){
    /* parameters:
       gl -  WebGL contex
    ...
    */
    ...
    //Oczekiwanie na załadowanie obrazka - wypełnienie niebieskim pixelem
    ...
    image.crossOrigin = "";
    image.src = "https://image.ibb.co/jyJjVo/Texture1.png";
...
function changeFaces(type){
    boxFaceTextures = [];
    for (i = 0; i<6; i++){
        boxFaceTextures.push( createTexture2D(gl, type) );
    }
    redraw();
}
